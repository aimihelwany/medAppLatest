  ...
  void _getTime() {
    ...
    setState(() {
      ...
      if (_alarmTimeFormatted == _timeString && buttonFlag == false) {
        ...
        t = new Timer.periodic(oneSec,
            (Timer t) => FlutterRingtonePlayer.playRingtone(looping: true));
        timeReached = true;
        print("Alarm Ringing");
      }
    });
...
//              padding: EdgeInsets.all(10.0),
                ...
                onTap: () async {
                  if (buttonFlag) {
                    ...
                    setState(() {
                      ...
                      _alarmTimeFormatted = _formatDateTime(_dateTime);
  ...
  Future scheuleAtParticularTime(DateTime timee) async {
    ...
    flutterLocalNotificationsPlugin.showDailyAtTime(
        0, alarmName, _alarmTimeDisplay, time, platformChannelSpecifics);
      ...
      child: new Column(
        children: <Widget>[
          new TextField(
              ...
              maxLength: 20,
              decoration: new InputDecoration(hintText: "Alarm Name"),
